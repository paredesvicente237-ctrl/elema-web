...
const charcoalSeries = [
  {
    ...
    shortDescription: 'Un elemento de fuego de frente extendido en acero inoxidable.',
    description: 'Fuego, superficie y estructura se integran en un elemento de gran frente útil para proyectos exteriores de mayor escala.',
  ...
  },
  {
    ...
    materials: ['Acero inoxidable'],
    shortDescription: 'Un elemento compacto de fuego en acero inoxidable.',
    description: 'Una proporción contenida reúne cocción, estructura y materia para integrarse en quinchos y espacios exteriores de distintas escalas.',
  ...
  },
  {
    ...
    shortDescription: 'Un elemento esencial de fuego en acero al carbono.',
    description: 'Los elementos indispensables de la cocción a carbón se concentran en una estructura sobria, directa y de lectura técnica.',
    sizes: [['S', '80 x 50 cm'], ['M', '90 x 50 cm'], ['L', '100 x 50 cm']],
  },
] as const;
...
charcoalProducts.push(
  createQuoteProduct({
    ...
    category: 'Parrillas',
    shortDescription: 'Un gran elemento de cocción para organizar distintas zonas de fuego.',
    description: 'Superficie, calor y preparación se ordenan dentro de un solo elemento de gran formato.',
    image: '/images/elema-generated/parrilla-montana-hero.webp',
  ...
  createQuoteProduct({
    ...
    category: 'Parrillas',
    shortDescription: 'Un elemento transportable para llevar el fuego fuera del quincho.',
    description: 'Movilidad, estructura y cocción forman una solución compacta que no depende de una instalación permanente.',
    image: '/images/elema-generated/parrilla-montana-hero.webp',
    materials: ['Materialidad a confirmar'],
  ...
  createQuoteProduct({
    ...
    category: 'Parrillas',
    shortDescription: 'Un elemento compacto para cocinar directamente sobre el fuego.',
    description: 'Escala reducida, movilidad y contacto directo con el fuego definen este elemento esencial para el exterior.',
    image: '/images/elema-generated/parrilla-montana-hero.webp',
    materials: ['Materialidad a confirmar'],
...
const hoodSeries = [
  {
    ...
    shortDescription: 'Un elemento de aire con geometría cónica para proyectos de quincho.',
    description: 'Volumen, aire y extracción forman un elemento suspendido que concentra su función sobre el fuego.',
  },
  {
    slug: 'campana-mediterranea',
    name: 'Campana Mediterránea',
    image: '/images/elema-generated/elema-concepto-campana-suspendida-v1.png',
    shortDescription: 'Un elemento longitudinal de aire y presencia arquitectónica.',
    description: 'Extracción, proporción horizontal y parrilla se articulan dentro de una composición integrada.',
  },
] as const;
...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Parrillas',
    shortDescription: 'Fuego, acero, piedra y cromo reunidos en un elemento arquitectónico.',
    description: 'Un elemento de presencia arquitectónica que ordena la materia alrededor del fuego y lo convierte en el centro de la experiencia exterior.',
    price: 799990,
  ...
  {
    id: 'parrilla-multiuso-movil',
    slug: 'parrilla-multiuso-movil',
    name: 'Parrilla Multiuso Móvil',
    category: 'Parrillas',
    ...
    images: [
      ...
      '/images/products/parrilla-multiuso-movil/parrilla-multiuso-movil-plancha.png',
      '/images/products/parrilla-multiuso-movil/parrilla-multiuso-movil-gabinete.png',
      '/images/products/parrilla-multiuso-movil/parrilla-multiuso-movil-almacenamiento.png',
      '/images/products/parrilla-multiuso-movil/parrilla-multiuso-movil-parrilla-elevada.png',
    ],
    materials: ['Acero', 'Acero inoxidable'],
    dimensions: 'Dimensiones por confirmar',
    finishes: ['Negro mate', 'Metal satinado'],
    features: ['Parrilla y plancha integradas', 'Estructura móvil', 'Gabinete inferior de guardado'],
    estimatedTime: 'A confirmar al momento de la compra',
    featured: true,
    available: true,
    customizable: false,
