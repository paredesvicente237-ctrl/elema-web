  ...
  return (
    <main className="min-h-screen bg-[#eee8de] px-4 pb-24 pt-28 text-[#171717] sm:px-6 lg:pt-36">
      <div className="mx-auto max-w-4xl border border-black/10 bg-[#f8f5ef] p-7 shadow-[0_25px_70px_rgba(20,16,10,0.08)] sm:p-12">
        ...
        <p className="mt-5 text-sm leading-7 text-[#69635d]">Esta política describe el tratamiento de información en los formularios, compras y cuentas de ELEM.</p>

        <div className="mt-10 space-y-9 text-sm leading-7 text-[#57514b]">
          <PolicySection title="Datos que utilizamos">
            Al crear una cuenta o solicitar una compra podemos almacenar nombre, correo, teléfono, dirección de entrega, detalle del pedido y sus actualizaciones. La contraseña es administrada por nuestro proveedor de autenticación y ELEM no puede verla.
          </PolicySection>
          <PolicySection title="Para qué los utilizamos">
            Usamos estos datos para autenticar tu acceso, gestionar solicitudes y pedidos, coordinar pagos y despachos, responder consultas, prevenir usos indebidos y mantener el historial visible en Mi ELEM.
          </PolicySection>
          <PolicySection title="Correos comerciales">
            Solo enviaremos publicidad cuando marques de forma separada que quieres recibirla. Puedes retirar esa autorización desde Mi ELEM o mediante el mecanismo de cancelación incluido en cada comunicación. Cancelar publicidad no impide recibir correos necesarios sobre un pedido activo.
          </PolicySection>
