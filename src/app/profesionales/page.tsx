      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          ...
          <div className="overflow-hidden border border-black/10 bg-[#e3ddd3] shadow-[0_24px_70px_rgba(20,16,10,0.10)]">
            <Image src="/images/elem-editorial/fabricacion-planta-elem-hd.png" alt="Planta ELEM preparada para fabricar conjuntos metálicos" width={2172} height={724} sizes="(min-width: 1024px) 58vw, 100vw" className="aspect-[3/1] w-full object-cover" priority />
          </div>
        </div>
